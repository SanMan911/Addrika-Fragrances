/**
 * RetailerProfileRequests - Submit and track profile change tickets
 * Retailers cannot change profile directly, they must raise a ticket
 */
import React, { useState, useEffect, useCallback } from 'react';
import { Link } from 'react-router-dom';
import { 
  ArrowLeft, FileEdit, Plus, Clock, CheckCircle, XCircle,
  AlertCircle, ChevronRight, User, Building, FileText, HelpCircle,
  Upload, X, Eye
} from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-blue-600 mt-1">
              To maintain data integrity, profile changes like name, address, GST, or SPOC details must be submitted as a request. You can only update your profile image directly.
            </p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-white rounded-xl">
            ...
            <p style={{ color: 'var(--text-subtle)' }}>No profile change requests yet</p>
            <Button 
              onClick={() => setShowForm(true)} 
              className="mt-4"
              style={{ backgroundColor: 'var(--japanese-indigo)' }}
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="font-mono text-sm" style={{ color: 'var(--metallic-gold)' }}>
                        {ticket.ticket_id}
                      </span>
                      <StatusBadge status={ticket.status} />
                    </div>
                    <h3 className="font-medium" style={{ color: 'var(--japanese-indigo)' }}>
                      {ticket.change_type_label}
                    </h3>
                    <p className="text-sm mt-1 line-clamp-2" style={{ color: 'var(--text-subtle)' }}>
                      {ticket.description}
                    </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      return (
                        <button
                          ...
                          style={{ 
                            ...
                            ringColor: isSelected ? 'var(--metallic-gold)' : 'transparent',
                        ...
                        >
                          <div 
                            ...
                            style={{ backgroundColor: isSelected ? 'var(--metallic-gold)20' : '#f3f4f6' }}
                          >
                            <Icon 
                              size={20} 
                              style={{ color: isSelected ? 'var(--metallic-gold)' : '#6b7280' }} 
                            />
                          </div>
                          <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full mt-2 px-3 py-2 border rounded-lg resize-none focus:outline-none focus:ring-2"
                    style={{ borderColor: 'var(--border)', '--tw-ring-color': 'var(--metallic-gold)' }}
                ...
                {/* New Value (Optional) */}
                <div>
                  <Label htmlFor="new_value" className="text-sm font-medium">
                    Proposed new value (optional)
                  </Label>
                  <Input
                    id="new_value"
                    ...
                    {documentName ? (
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <FileText size={16} style={{ color: 'var(--metallic-gold)' }} />
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <h2 className="text-xl font-bold mt-1" style={{ color: 'var(--japanese-indigo)' }}>
                    {selectedTicket.change_type_label}
                  </h2>
                </div>
                <button 
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1" style={{ color: 'var(--japanese-indigo)' }}>
                ...
                {selectedTicket.new_value && (
                  <div>
                    ...
                    <p className="mt-1 font-medium" style={{ color: 'var(--metallic-gold)' }}>
                      {selectedTicket.new_value}
                    </p>
                  </div>
                )}
                ...
                <div className="flex gap-3 pt-4">
                  <Button
                    ...
                    onClick={() => setSelectedTicket(null)}
                    className="w-full"
                    data-testid="close-detail-btn-bottom"
                  >
                    Close
                  </Button>
                </div>
...
export default RetailerProfileRequests;
