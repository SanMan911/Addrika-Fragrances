  ...
  return (
    <a
      ...
      style={{
        ...
        padding: isHovered ? '14px 22px 14px 16px' : '16px',
        boxShadow: isHovered
          ? '0 8px 32px rgba(37,211,102,0.45), 0 2px 8px rgba(0,0,0,0.15)'
          : '0 4px 20px rgba(37,211,102,0.35), 0 2px 6px rgba(0,0,0,0.1)',
