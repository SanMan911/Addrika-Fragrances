...
| Variable Name | Value |
|---------------|-------|
| `NEXT_PUBLIC_API_URL` | `https://auth-preview-23.preview.emergentagent.com` |

**How to add:**
1. In Vercel project settings, go to **Settings → Environment Variables**
2. Add: `NEXT_PUBLIC_API_URL` = `https://auth-preview-23.preview.emergentagent.com`
...
- URL: `https://auth-preview-23.preview.emergentagent.com`
