...
| Variable Name | Value |
|---------------|-------|
| `NEXT_PUBLIC_API_URL` | `https://b2b-handoff.preview.emergentagent.com` |

**How to add:**
1. In Vercel project settings, go to **Settings → Environment Variables**
2. Add: `NEXT_PUBLIC_API_URL` = `https://b2b-handoff.preview.emergentagent.com`
...
- URL: `https://b2b-handoff.preview.emergentagent.com`
