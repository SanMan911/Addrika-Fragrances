...
def _draw_inner_flap(c: canvas.Canvas, x: float, active_count: int):
    ...
    body = (
        ...
        "India, many run in partnership with Women's Self-Help Groups "
        "(SHGs) — where artisans earn fair, dignified wages and enjoy "
        "flexible work-hours around family. Wherever possible we source "
        "directly, so more of the value stays close to the hands that "
        "shaped it.\n\n"
        "Zero charcoal. Ethically sourced ingredients. Packaging designed "
        "to compost, recycle, or be reused. Over 60% less smoke than "
        "ordinary agarbattis — a supply chain that gives back more than "
        "it takes.\n\n"
